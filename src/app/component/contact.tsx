...
export default function Contact() {
    return (
        <div id="contact" className="pl-18 bg-gradient-to-r from-pink-500   to-purple-500 via-95% ">
            <section className=" body-font relative">
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2= rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative border-solid border-2 border-indigo-600">
                        ...
                        />
                        <div className="bg-gradient-to-r from-pink-500   to-purple-500 via-95% relative flex flex-wrap py-6 rounded shadow-md border-solid border-2 border-indigo-600 bg-opacity-color-20">
                    ...
                    <div className="lg:w-1/3 md:w-1/2 bg-gradient-to-r from-pink-500   to-purple-500 via-95% flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 border-solid border-2 border-indigo-600 pl-3 pr-3">
